...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "CaterFlow — Plan your celebration food, warmly" },
      {
        name: "description",
        content:
          "A Telugu-first conversational planner for weddings, birthdays and family events. Slow, warm, and hayi ga.",
      },
      { property: "og:title", content: "CaterFlow" },
      {
        property: "og:description",
        content: "Mee function food, slow ga, hayi ga.",
      },
    ],
  }),
